...
#AUTHOR : CHIGOZIEWORLDWIDE (AAA)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO AAA
...
header = {"user-agent": '[Mozilla/5.0 (Windows; U; Windows NT 6.0; nb-NO) AppleWebKit/533.18.1 (KHTML, like Gecko) Version/5.0.2 Safari/533.18.5;]',
